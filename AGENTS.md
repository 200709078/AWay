...
NOT: Bunlar birer öneridir. Uygulamdığında mevcut sistemin çalışmasını sıkıntıya sokacaksa uygulanmayabilir veya farklı bir şekilde uygulanması için yeni bir öneride (böyle değil de şöyle olabilir gibi) bulunulabilir. 
