...
export function getAttendanceBoard(
  ...
  return request<AttendanceBoard>(
    `/schools/${encodeURIComponent(schoolId)}/attendances/board?date=${encodeURIComponent(date)}`,
  );
}
...
export function getAttendanceEntryContext(
  ...
  return request<AttendanceEntryContext>(
    `/schools/${encodeURIComponent(schoolId)}/attendances/entry-context?${query.toString()}`,
  );
}
...
export function createAttendance(
  ...
  return request<AttendanceSummary>(
    `/schools/${encodeURIComponent(schoolId)}/attendances`,
...
export function getAttendanceDetail(
  ...
  return request<AttendanceDetail>(
    `/schools/${encodeURIComponent(schoolId)}/attendances/${encodeURIComponent(attendanceId)}`,
  );
}
...
export function reviewLockAttendance(
  ...
  return request<AttendanceSummary>(
    `/schools/${encodeURIComponent(schoolId)}/attendances/${encodeURIComponent(attendanceId)}/review-lock`,
    { method: "POST" },
  );
}
...
export function createAttendanceEditRequest(
  ...
  return request<AttendanceEditRequest>(
    `/schools/${encodeURIComponent(schoolId)}/attendances/${encodeURIComponent(attendanceId)}/edit-requests`,
